...
abstract class $DirectGeocodingCopyWith<$Res> {
  ...
  @useResult
  $Res call({String name, double lat, double lng, String country});
}
...
class _$DirectGeocodingImpl implements _DirectGeocoding {
  const _$DirectGeocodingImpl(
      {this.name = "", this.lat = 0.0, this.lng = 0.0, this.country = ""});
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, name, lat, lng, country);
